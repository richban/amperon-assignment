...
from etl.tomorrow_io_pipeline import (
    locations,
    get_normalized_run_timestamp,
...
class TestTimeUtilityFunctions:
    ...
    def test_get_normalized_run_timestamp_without_argument(self):
        """Test timestamp normalization with current time."""
        result = get_normalized_run_timestamp()
    ...
    def test_get_normalized_run_timestamp_with_iso_string(self):
        """Test timestamp normalization with ISO string input."""
        test_input = "2025-12-23T13:45:30"
        result = get_normalized_run_timestamp(test_input)
    ...
    def test_get_normalized_run_timestamp_with_utc_suffix(self):
    ...
    def test_get_normalized_run_timestamp_floors_correctly(self):
        ...
        results = [get_normalized_run_timestamp(tc) for tc in test_cases]
    ...
    def test_get_absolute_time_params_returns_dict(self):
        ...
        run_ts = datetime(2025, 12, 23, 13, 0, 0, tzinfo=timezone.utc)
        result = get_absolute_time_params(run_ts)
    ...
    def test_get_absolute_time_params_time_window(self):
        ...
        # Start should be 24 hours before run_ts
        expected_start = run_ts - timedelta(hours=24)
        assert start == expected_start

        # End should be 5 days after run_ts
        expected_end = run_ts + timedelta(days=5)
